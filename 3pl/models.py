...
PAGE_REGISTRY = {
    ...
    'operator.shipments':  {'label': '출고관리',     'icon': 'bi-truck',          'portal': 'operator', 'min_role': 'cs'},
...
MENU_GROUPS = {
    'operator': [
        ...
        {'label': '재고',     'icon': 'bi-archive',        'items': ['operator.inventory', 'operator.inbound', 'operator.adjustment', 'operator.ledger']},
